(() => {
  ...
  const COMPLIMENTS = [
  "💖 تو نازترین پرنسس جهانی 👸",
  "💕 تو زیباترین دختر دنیایی 👑",
  "❤️ تو خوشگل‌ترین پرنسس کهکشانی ✨",
  "💗 تو قشنگ‌ترین خلقت جهانی 👸",
  "💖 تو خاص‌ترین دختر تمام دنیایی 💕",
  "👑 تو زیباترین ملکه‌ی جهانی ❤️",
  "💕 تو دوست‌داشتنی‌ترین دختر دنیایی 💖",
  "❤️ تو شیرین‌ترین پرنسس جهانی 👸",
  "💗 تو جذاب‌ترین دختر کهکشانی ✨",
  "✨ تو درخشان‌ترین ستاره‌ی جهانی 💖",

  "💕 تو مهربون‌ترین دختر دنیایی ❤️",
  "👸 تو پرنسس افسانه‌ای جهانی 💗",
  "💖 تو دلبرترین دختر دنیایی 💕",
  "❤️ تو زیباترین لبخند جهان رو داری 😊",
  "💗 تو نازترین دختر روی زمینی 👸",
  "👑 تو زیباترین ملکه‌ی دنیایی ❤️",
  "💕 تو شیرین‌ترین دختر جهانی 💖",
  "❤️ تو بی‌نظیرترین دختر کهکشانی ✨",
  "💖 تو دوست‌داشتنی‌ترین پرنسس جهانی 👸",
  "💕 تو قشنگ‌ترین رؤیای جهانی 💗",

  "❤️ تو ماهِ زیبای این آسمونی 🌙",
  "💖 تو درخشان‌ترین ستاره‌ی آسمونی ✨",
  "👸 تو زیباترین پرنسس افسانه‌هایی 💕",
  "💗 تو زیباتر از تمام ستاره‌هایی ⭐",
  "❤️ تو نازتر از تمام گل‌های دنیایی 🌸",
  "💕 تو قشنگ‌ترین لبخند جهانی 😊",
  "👑 تو ملکه‌ی زیبایی تمام جهانی ❤️",
  "💖 تو خاص‌ترین دختر این کهکشانی 🌌",
  "❤️ تو شیرین‌ترین دختر روی زمینی 💗",
  "👸 تو پرنسس بی‌رقیب جهانی 👑",

  "💕 تو زیباترین منظره‌ی دنیایی 💖",
  "💗 تو آرامش‌بخش‌ترین چهره‌ی جهانی ❤️",
  "✨ تو نورانی‌ترین ستاره‌ی کهکشانی 💕",
  "❤️ تو قشنگ‌ترین بخش خلقتی 💖",
  "👸 تو نازترین پرنسس تمام کهکشانی 🌌",
  "💕 تو قشنگ‌ترین فرشته‌ی دنیایی 😇",
  "💖 تو رویایی‌ترین دختر جهانی 👑",
  "❤️ تو شیرین‌ترین دختر تمام جهانی 💗",
  "💕 تو زیباترین حسِ دنیا رو داری ✨",
  "👸 تو پرنسس شماره یک جهانی 💖",

  "💖 هیچکس به زیبایی تو نیست ❤️",
  "💕 هیچکس مثل تو خاص نیست 👑",
  "❤️ هیچکس به ناز بودن تو نمی‌رسه 💗",
  "👸 تو تک‌پرنسس تمام جهانی 💖",
  "💗 تو قشنگ‌ترین دختری که می‌شه دید ❤️",
  "💕 تو جذاب‌ترین دختر این جهانی ✨",
  "👑 تو ملکه‌ی بی‌رقیب زیبایی 💖",
  "❤️ تو نازترین لبخند دنیایی 😊",
  "💖 تو خوشگل‌ترین دختر این سیاره‌ای 🌎",
  "💕 تو خاص‌ترین پرنسس کهکشانی 👸",

  "❤️ تو قشنگ‌ترین دختر تمام رؤیاهایی 💗",
  "👸 تو همون پرنسس واقعی افسانه‌هایی 💖",
  "💗 تو زیباترین دلیل لبخند زدنی ❤️",
  "💕 تو شیرین‌ترین دختر روی زمینی 🍓",
  "💖 تو جذاب‌ترین پرنسس جهانی 👑",
  "❤️ تو قشنگ‌ترین دختر تمام جهانی 💕",
  "👸 تو نازترین پرنسس قصه‌هایی 📖",
  "💗 تو زیباترین دختر رؤیاهایی ✨",
  "💕 تو بهترین نمونه‌ی زیبایی جهانی ❤️",
  "👑 تو زیباترین ملکه‌ی تمام زمان‌هایی 💖",

  "❤️ زیباترین چشم‌های دنیا رو تو داری 👀",
  "💖 زیباترین لبخند دنیا برای توئه 😊",
  "💕 زیباترین موهای دنیا برای توئه 👸",
  "❤️ زیباترین صورت دنیا مال توئه 💗",
  "👑 زیباترین چهره‌ی دنیا رو تو داری 💖",
  "💗 زیباترین نگاه دنیا برای توئه 👀",
  "💕 زیباترین دستان دنیا برای مهساست 🤲",
  "❤️ زیباترین لب‌های دنیا برای توئه 💋",
  "💖 زیباترین خنده‌ی دنیا رو تو داری 😊",
  "👸 زیباترین چشمان جهان برای توئه ✨",

  "💕 قشنگ‌ترین چشم‌های جهان رو داری 👀",
  "💖 نازترین صورت جهان رو داری 👸",
  "❤️ زیباترین لبخند جهان رو داری 😊",
  "💗 جذاب‌ترین نگاه جهان رو داری ✨",
  "💕 زیباترین موهای جهان رو داری 👑",
  "❤️ ظریف‌ترین دستان دنیا برای توئه 🤲",
  "💖 نازترین لبخند تمام کهکشانی 😊",
  "👸 زیباترین چهره‌ی تمام جهانی 💕",
  "💗 قشنگ‌ترین نگاه تمام دنیا برای توئه 👀",
  "👑 زیباترین دختر تمام کهکشان تویی 🌌",

  "💖 تو زیباترین شاهکار خلقتی ✨",
  "💕 تو قشنگ‌ترین اثر هنری جهانی 🎨",
  "❤️ تو زیباترین دختر تمام خلقتی 👸",
  "💗 تو نازترین موجود تمام جهانی 💖",
  "💕 تو زیباترین پرنسس تمام آسمونی 👑",
  "❤️ تو قشنگ‌ترین گلِ باغ جهانی 🌸",
  "💖 تو درخشان‌ترین دختر تمام کهکشانی ✨",
  "👸 تو زیباترین پرنسس تمام افسانه‌هایی 💕",
  "💗 تو نازترین دختر تمام زمان‌هایی ❤️",
  "👑 تو زیباترین ملکه‌ی تمام جهانی 💖",

  "💕 تو قشنگ‌ترین دختر روی زمین هستی 🌎",
  "❤️ تو زیباترین دختر زیر این آسمونی 🌙",
  "💖 تو نازترین پرنسس تمام سیاره‌ای 👸",
  "💗 تو خوشگل‌ترین دختر تمام کهکشانی 🌌",
  "💕 تو زیباترین دختر تمام جهان هستی ❤️",
  "👑 تو خاص‌ترین پرنسس تمام دنیایی 💖",
  "❤️ تو نازترین دختر تمام جهانی 💕",
  "💖 تو قشنگ‌ترین پرنسس تمام آسمونی 👸",
  "💕 تو زیباترین خلقت تمام جهانی ✨",
  "👸 تو تا همیشه زیباترین پرنسس جهانی ❤️"
];
  ...
  const complimentIndex = score - 1;

  if (complimentIndex >= 0 && complimentIndex < COMPLIMENTS.length) {
    showToast(COMPLIMENTS[complimentIndex]);
  }
}
